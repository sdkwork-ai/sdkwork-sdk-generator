# Runbook — sdkwork-sdk-generator deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-sdk-generator-standalone:1.0.9`
...
install syncs the bundle to `/opt/deploy/sdkwork-sdk-generator/bundle`, loads the image, starts
...
bin/docker-deploy.sh rollback --environment staging --to 1.0.9       # explicit version
```
